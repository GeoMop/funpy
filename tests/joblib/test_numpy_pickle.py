...
from _test_common import np, with_numpy, with_lz4, without_lz4
from _test_common import with_memory_profiler, memory_used
from funpy.joblib.testing import parametrize, raises, warns

# numpy_pickle is not a drop-in replacement of pickle, as it takes
# filenames instead of open files as arguments.
from funpy.joblib import numpy_pickle, register_compressor
import _test_data

from funpy.joblib.numpy_pickle_utils import _IO_BUFFER_SIZE
from funpy.joblib.numpy_pickle_utils import _detect_compressor
from funpy.joblib.numpy_pickle_utils import _is_numpy_array_byte_order_mismatch
from funpy.joblib.numpy_pickle_utils import _ensure_native_byte_order
from funpy.joblib.compressor import (_COMPRESSORS, _LZ4_PREFIX, CompressorWrapper,
...
def test_joblib_pickle_across_python_versions():
    ...
    test_data_dir = os.path.dirname(os.path.abspath(_test_data.__file__))
